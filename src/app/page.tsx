...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-zinc-50 dark:bg-black flex items-center justify-center px-4 py-6 sm:p-8">
      <main className="w-full max-w-xl mx-auto flex flex-col gap-6">
        <header className="text-center">
          ...
          <p className="mt-2 text-xs lg:text-sm text-zinc-600 dark:text-zinc-400">
